  ...
  return (
    <div className='pt-[40px] px-[120px] w-full flex flex-col justify-center items-center'>
      <div className='flex flex-col w-full  '>
        <div className=' pb-[27px] font-normal text-[#666666]'>Our Brow mailer boxes" typically refer to mailer boxes that have a distinctive brow or kraft paper appearance. These boxes are often used for packaging and shipping various products. Here are some common features and characteristics of brow mailer boxes</div>
