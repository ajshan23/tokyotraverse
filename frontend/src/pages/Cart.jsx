...
const handleProceed = () => {
  ...
  return (
    <Fragment>
    <div className="w-full pb-10 px-[120px] flex flex-col">
      ...
      <div className="body flex flex-row w-full">
        <div className="cartitems w-[808px] flex flex-col">
          <div className="h-[1px] w-[756px] bg-[#F01F26] mb-4"></div>
       <div className="w-full h-[500px] overflow-y-scroll scroll-container">
       {
        ...
        <div className="productsummury ml-28 w-full flex flex-col">
          ...
          <div className="w-full m-3 border border-gray-300 rounded-xl shadow-xl flex flex-col items-center">
            ...
            <div className="w-full h-36 pt-2 pl-10 text-gray-600 overflow-y-scroll scroll-container scroll-container">
              {cart &&
                cart.map((item, index) => (
            ...
            <button
              className="px-24 mt-3 py-2 bg-[#F01F26] text-white font-lexend font-bold text-xl rounded-lg my-3" onClick={handleProceed}
            >
              Proceed to buy
            </button>
          </div>
