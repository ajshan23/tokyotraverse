    ...
    <div className="flex flex-col w-full">
      ...
      >
        <div className="aboutus w-full h-full bg-[#F01F26] bg-opacity-80">
          <div className="textaboutus w-full h-full px-[120px] pb-6 flex justify-start items-end font-lexend text-4xl font-bold text-white">
            ABOUT US
          </div>
        </div>
      </div>
      <div className=" w-full flex flex-col pt-[21px] px-[120px] font-lexend pb-10">
        <div className="h-[278px]  w-full flex flex-col">
          ...
          <div className="h-[1.5px] w-[855px] bg-[#F01F26]"></div>
        </div>
        <div className="flex flex-row  w-full relative">
          ...
          <div className="flex flex-col font-lexend ">
            ...
            <div className="pt-[14px] w-[638px] text-sm text-gray-500">
            ...
            <div className="pt-[14px] w-[638px] pb-[45px] text-sm text-gray-500">
            ...
            <div className="h-[2px] w-[738px]  bg-[#F01F26]"></div>
          </div>
        </div>
        <div className="flex flex-row  w-full relative">
          <div className="flex flex-col font-lexend ">
            ...
            {/* <div className="absolute bottom-0 h-[2px] w-full  bg-[#F01F26]"></div> */}
          </div>
          <div className="w-[50%]">
            <img
              src={pic2}
        ...
        <div className="flex flex-col h-[450px] justify-between">
          <div className="  h-[2px] w-full  bg-[#F01F26]"></div>
          <div className="flex flex-row justify-center ">
            <div className="flex flex-col justify-start items-start pr-[40px] border-r-2 border-[#F01F26] ">
              <img src={man1} alt="" className="w-[236px] h-[271px] " />
              <h1 className="font-semibold pt-[10px] pb-[2px]">Danny Chad</h1>
              <p className="text-sm font-sans">CEO</p>
            </div>
            <div className="flex flex-col justify-start items-start pl-[40px]">
              <img
                src={man2}
                alt=""
                className="w-[282px] h-[271px] pr-[40px] border-r-2 border-[#F01F26]"
              />
            ...
            <div className="flex flex-col justify-start items-start pl-[40px]">
              <img src={man4} alt="" className="w-[236px] h-[271px] " />
